                            ...
                            <div className="space-y-1">
                                {Object.keys(BACKEND_FILES).map((file) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2 rounded text-sm font-mono flex items-center ${selectedFile === file ? 'bg-blue-100 text-blue-700 font-bold' : 'text-gray-600 hover:bg-gray-100'
                                            }`}
                                    >
