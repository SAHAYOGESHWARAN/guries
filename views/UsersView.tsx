                        ...
                        {teams.map(team => {
                            ...
                            return (
                                <div 
                                    ...
                                    className={`bg-white rounded-xl shadow-sm border transition-all flex flex-col ${
                                        isOver ? 'border-indigo-500 ring-2 ring-indigo-100 scale-[1.01]' : 'border-slate-200 hover:border-indigo-200'
                                    }`}
                                >
                                    {/* Team Header */}
      ...
      <Modal isOpen={isAddUserModalOpen} onClose={() => setIsAddUserModalOpen(false)} title="Invite New User">
          <div className="space-y-4">
              ...
              <div>
                  ...
                  <input type="email" value={newUser.email} onChange={(e) => setNewUser({...newUser, email: e.target.value})} className="block w-full border-slate-300 rounded-lg shadow-sm p-2 text-sm focus:ring-indigo-500 focus:border-indigo-500" />
              </div>
              <div>
