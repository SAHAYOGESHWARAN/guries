                            ...
                            {activeTab === 'SEO' && (
                                <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-sm space-y-8">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        ...
                                        <div className="p-5 rounded-xl border border-slate-200 bg-white space-y-4 lg:col-span-3">
                                            <KeywordSelector
                                                ...
                                                label="Meta Keywords"
                                                description="Keywords for search engine metadata"
                                        ...
                                        <div className="p-5 rounded-xl border border-slate-200 bg-slate-50 space-y-4 lg:col-span-3">
                                            <KeywordSelector
                                                ...
                                                description="Primary phrases we actively monitor"
                                                placeholder="Search keywords from master list..."
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        <div className="p-5 rounded-xl border border-slate-200 bg-white space-y-4 lg:col-span-2">
                                            <KeywordSelector
                                                ...
                                                description="Semantic helpers & support terms"
                                                placeholder="Search keywords from master list..."
                                            />
                                        </div>

                                        <div className="p-5 rounded-xl border border-slate-200 bg-white space-y-5 lg:col-span-2">
                                            <div>
