            ...
            <div>
                ...
                <div className="relative">
                    <input
                        ...
                        className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all ${
                            !isValid 
            ...
            <div>
                ...
                <div className="relative">
                    <input
                        ...
                        className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all font-mono text-sm ${
                            !isValid 
                                ? 'border-red-300 bg-red-50' 
                                : 'border-slate-300 bg-white'
                        } ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
