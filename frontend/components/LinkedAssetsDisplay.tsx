    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h3 className="text-lg font-bold text-slate-800">Linked Assets</h3>
                            ...
                            <div className="space-y-2 text-xs">
                                ...
                                {asset.qc_status && (
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className={`px-2 py-1 rounded font-semibold ${asset.qc_status === 'Pass' || asset.qc_status === 'Approved' ? 'bg-green-100 text-green-700' :
                                                asset.qc_status === 'Pending' ? 'bg-yellow-100 text-yellow-700' :
                                ...
                                {asset.qc_score !== undefined && (
                                    <div className="flex items-center justify-between">
                                        <span className="text-slate-600">Score:</span>
                                        <span className="font-bold text-blue-600">{asset.qc_score}/100</span>
                                    </div>
                                )}
