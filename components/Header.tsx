    ...
    <header className="h-16 flex items-center justify-between px-4 lg:px-6 bg-white/95 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40 transition-all duration-200">
      ...
      <div className="flex items-center gap-2 lg:gap-4">
        ...
        <div className="relative profile-container">
          ...
          >
            <img className="h-8 w-8 lg:h-9 lg:w-9 rounded-full border-2 border-slate-200 shadow-sm object-cover" src="https://ui-avatars.com/api/?name=Guires&background=4f46e5&color=fff&size=36" alt="User" />
            ...
            <div className="absolute right-0 mt-3 w-72 bg-white rounded-xl shadow-lg border border-slate-100 py-3 z-50 animate-fade-in origin-top-right">
              <div className="px-4 pb-3 border-b border-slate-100">
                <div className="flex items-center gap-3">
                  <img className="h-12 w-12 rounded-full border-2 border-slate-200 shadow-sm object-cover" src="https://ui-avatars.com/api/?name=Guires&background=4f46e5&color=fff&size=48" alt="User" />
