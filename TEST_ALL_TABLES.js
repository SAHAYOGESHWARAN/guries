...
const tableStructureTests = [
    ...
    {
        table: 'services',
        columns: ['id', 'service_name', 'service_code', 'slug', 'status', 'meta_title', 'meta_description']
    },
    {
        table: 'sub_services',
        columns: ['id', 'service_id', 'sub_service_name', 'status', 'meta_title', 'meta_description']
    },
    {
        table: 'keywords',
        columns: ['id', 'keyword_name', 'keyword', 'search_volume', 'difficulty_score', 'status']
    },
    {
    ...
    },
    {
        ...
        columns: ['id', 'url', 'error_type', 'severity', 'status', 'assigned_to_id']
    },
    {
        table: 'qc_runs',
        columns: ['id', 'target_type', 'target_id', 'qc_status', 'qc_owner_id']
    },
    {
        table: 'projects',
        columns: ['id', 'project_name', 'project_code', 'status', 'owner_id', 'brand_id']
    },
    {
        table: 'campaigns',
        columns: ['id', 'campaign_name', 'campaign_type', 'status', 'campaign_owner_id', 'project_id']
    }
];
...
if (failedTables.length > 0) {
    console.log(`\n⚠️  Missing Tables: ${failedTables.join(', ')}`);
}
...
if (failedTests === 0) {
    ...
    console.log(`❌ ${failedTests} TESTS FAILED - PLEASE REVIEW\n`);
    process.exit(1);
}
