...
(1, 'SEO Optimization', 'SEO-001', 'seo-optimization', '/services/seo-optimization', 'SEO Services', 'Boost your online visibility', 'Comprehensive SEO services to improve your search rankings', 'Published', 'Professional SEO Optimization Services', 'SEO Optimization Services | Expert Solutions', 'Improve your search rankings with our professional SEO services', 'Pillar', 'Awareness', 'en', 1, 1, datetime('now', 'localtime'), datetime('now', 'localtime')),
(2, 'Content Marketing', 'CM-001', 'content-marketing', '/services/content-marketing', 'Content Services', 'Engage your audience with quality content', 'Strategic content creation and distribution services', 'Published', 'Content Marketing Solutions', 'Content Marketing Services | Professional Writers', 'High-quality content creation for your brand', 'Pillar', 'Consideration', 'en', 1, 1, datetime('now', 'localtime'), datetime('now', 'localtime')),
(3, 'Social Media Management', 'SMM-001', 'social-media-management', '/services/social-media-management', 'Social Media', 'Grow your social presence', 'Complete social media management and strategy services', 'Published', 'Social Media Management Services', 'Social Media Management | Expert Strategy', 'Grow your brand on social media with expert management', 'Pillar', 'Awareness', 'en', 1, 1, datetime('now', 'localtime'), datetime('now', 'localtime')),
(4, 'PPC Advertising', 'PPC-001', 'ppc-advertising', '/services/ppc-advertising', 'Paid Advertising', 'Maximize your ad ROI', 'Strategic PPC campaigns for Google Ads and social platforms', 'Published', 'PPC Advertising Services', 'PPC Advertising Services | Google Ads Experts', 'Maximize your advertising ROI with expert PPC management', 'Pillar', 'Decision', 'en', 1, 1, datetime('now', 'localtime'), datetime('now', 'localtime')),
(5, 'Email Marketing', 'EM-001', 'email-marketing', '/services/email-marketing', 'Email Services', 'Connect with your customers', 'Effective email marketing campaigns and automation', 'Published', 'Email Marketing Services', 'Email Marketing Services | Campaign Experts', 'Effective email marketing campaigns for your business', 'Cluster', 'Retention', 'en', 1, 1, datetime('now', 'localtime'), datetime('now', 'localtime'));
